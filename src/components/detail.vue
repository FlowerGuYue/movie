...
.detail_list .detail_list_info{ margin-top:6px;}
...
.detail_list .detail_list_info p{ color:white; line-height: 20px; font-size: 14px; color:#ccc;margin-bottom:3px;}
 .detail_intro{ padding: 10px;}
  .detail_intro p{text-indent:30px;}
